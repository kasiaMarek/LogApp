...
data class Worklog(val id : String, val issueId : String, var issueKey : String, var issueSummary : String, val started : String, var timeSpentSeconds : String, val author : User)
